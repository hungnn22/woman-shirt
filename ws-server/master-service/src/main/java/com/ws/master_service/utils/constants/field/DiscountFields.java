package com.ws.master_service.utils.constants.field;
...
public class DiscountFields {
    ...
    public static final String START_TIME = "Thời gian bắt đầu";
    public static final String END_DATE = "Ngày kết thúc";
    public static final String END_TIME = "Thời gian kết thúc";
    public static final String MAXIMUM_SHIPPING_RATE = "Áp dụng với phí vận chuyển dưới";
    public static final String ADDRESS_LIST = "Danh sách địa chỉ";
