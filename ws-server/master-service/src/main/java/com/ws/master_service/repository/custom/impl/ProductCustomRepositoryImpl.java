...
import com.ws.master_service.dto.customer.product.search.ProductDto;
import com.ws.master_service.repository.custom.ProductCustomRepository;
...
import com.ws.master_service.utils.common.JpaUtils;
...
public class ProductCustomRepositoryImpl implements ProductCustomRepository {
    ...
    public PageData<ProductResponse> search(ProductReq req) {
        var prefix = "select\n";
        var select =
                "new com.ws.master_service.dto.customer.product.ProductResponse(\n" +
                        "p.id as productId,\n" +
...
//                "left join TypeEntity t on p.typeId = t.id\n" +
    ...
    @Override
    public Object searchV2(com.ws.master_service.dto.customer.product.search.ProductReq req) {
