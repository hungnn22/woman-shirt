...
import com.ws.master_service.dto.customer.user.UserDto;
...
public interface UserRepository extends JpaRepository<UserEntity, String> {
    ...
    @Query("select new com.ws.master_service.utils.base.rest.CurrentUser(\n" +
            "u.id,\n" +
    ...
    @Query("select new com.ws.master_service.dto.customer.user.UserDto(" +
            "u.email,\n" +
            "u.password,\n" +
            "u.role)\n" +
            "from UserEntity u\n" +
