...
import com.ws.master_service.dto.admin.dashboard.CategoryRevenueDto;
import com.ws.master_service.dto.admin.dashboard.EarningDayDto;
import com.ws.master_service.entity.OrderEntity;
...
public interface OrderRepository extends JpaRepository<OrderEntity, String> {
     ...
     */
    @Query("select new com.ws.master_service.dto.admin.dashboard.EarningDayDto(\n" +
     ...
     */
    @Query("select new com.ws.master_service.dto.admin.dashboard.CategoryRevenueDto(\n" +
            "c.id as cId,\n" +
            "c.name as cName,\n" +
